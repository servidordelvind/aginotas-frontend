    ...
    <div className="min-h-screen bg-[#161e2e] text-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <main className="pt-16 md:pt-20">
        ...
        >
          ...
          <div className="max-w-full lg:max-w-xl mb-10 lg:mb-0 text-center lg:text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="#features" className="bg-[#2962FF] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#1E50D9] transition-colors inline-block text-center">
                SAIBA MAIS
              </a>
              <Link to="/register" className="border border-[#2962FF] text-white px-6 py-3 rounded-full font-medium hover:bg-[#2962FF]/10 transition-colors inline-block text-center">
                TESTE GRÁTIS
              </Link>
            </div>
          </div>
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="text-center mt-12">
              <Link to="/register" className="bg-[#2962FF] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#1E50D9] transition-colors relative inline-block">
                <span className="absolute left-[8px] top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white rounded-full"></span>
                TESTE GRÁTIS
              </Link>
            </div>
